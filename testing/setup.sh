...
echo "   2. View UI: http://localhost:4200"
echo "   3. Run tests: ${PYTHON} testing/run_tests.py"
echo "   3. Check status: docker compose -f docker/compose.yml ps"
echo "   4. View logs: docker compose -f docker/compose.yml logs -f"
echo ""
