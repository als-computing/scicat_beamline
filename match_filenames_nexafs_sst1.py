...
metadata_table = pandas.read_csv("/home/j/programming/work/datasets/SAF-309867-ML/M-WET Fall 2022 Beamtime.csv", dtype=str)
...
for path in glob.glob("/home/j/programming/work/datasets/SAF-309867-ML/*"):
    ...
    if pos > -1:
        ...
        name_in_spread = name_in_spread[0:pos2+1] + "PEY_" + name_in_spread[pos2+1:]
        ...
        for idx, entry in enumerate(metadata_table["scan_id"]):
            if str(entry).strip() == name_in_spread:
                ...
                if str(metadata_table.loc[idx, "file_name"]) == 'nan':
                    ...
                    metadata_table.loc[idx, "file_name"] = str(metadata_table.loc[idx, "file_name"]) + f",{path_name}"
                match = True
