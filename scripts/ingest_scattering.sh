...
python scicat_beamline_ingestion/ingest.py --username "$SCICAT_INGEST_USERNAME" --password "$SCICAT_INGEST_PASSWORD" "als_11012_scattering" "$ROOT_FOLDER" "$SCICAT_INGEST_OWNER_USERNAME" "$SCICAT_INGEST_URL"
